...
const INPUT_CLASS =
  "px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-900 placeholder:text-slate-400 focus:ring-4 focus:ring-red-100 focus:border-red-500 transition-all outline-none";
            ...
            <section className="space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                {aggregation.map((row) => {
                  ...
                  const barBg = row.count === 0 ? "bg-slate-100" : "bg-red-500/60";
                  return (
                    <button
